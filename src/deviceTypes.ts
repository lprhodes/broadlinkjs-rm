import { DeviceTypes } from './definitions';

// RM Devices (without RF support)
const supportedDevices: DeviceTypes = {};
...
const rfSupportedDevices: DeviceTypes = {};
...
const unsupportedDevices: DeviceTypes = {};
...
export { supportedDevices, rfSupportedDevices, unsupportedDevices };
